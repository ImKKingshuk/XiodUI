...
| autoHighlight | `boolean \| "always" \| undefined` | `"always"` |
| children | `ReactNode` | — |
...
| itemToStringValue | `((itemValue: unknown) => string) \| undefined` | — |
| keepHighlight | `boolean \| undefined` | `true` |
...
| onItemHighlighted | `((highlightedValue: unknown, eventDetails: HighlightEventDetails) => void) \| undefined` | — |
