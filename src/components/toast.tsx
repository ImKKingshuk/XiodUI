...
import { Alert as TriangleAlertIcon } from "xiod-icons/icons/Alert";
...
import { CheckmarkCircle as CircleCheckIcon } from "xiod-icons/icons/CheckmarkCircle";
      ...
      >
        {toasts.map((toast) => {
          ...
          const showCloseButton =
            (toast as { closeButton?: boolean }).closeButton ??
            (toast.data as { closeButton?: boolean })?.closeButton ??
            closeButton;
