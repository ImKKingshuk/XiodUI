...
function AutocompleteItem({
  ...
  return (
    <AutocompletePrimitive.Item
      className={cn(
        "flex min-h-8 cursor-default select-none items-center gap-2 rounded-sm px-2 py-1 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:opacity-64 sm:min-h-7 sm:text-sm",
        className,
      )}
...
function AutocompleteSeparator({
  className,
  ...props
}: AutocompletePrimitive.Separator.Props): React.JSX.Element {
  return (
...
function AutocompleteGroup({
  className,
  ...props
}: AutocompletePrimitive.Group.Props): React.JSX.Element {
  return (
...
function AutocompleteGroupLabel({
  className,
  ...props
}: AutocompletePrimitive.GroupLabel.Props): React.JSX.Element {
  return (
...
function AutocompleteEmpty({
  className,
  ...props
}: AutocompletePrimitive.Empty.Props): React.JSX.Element {
  return (
...
function AutocompleteRow({
  className,
  ...props
}: AutocompletePrimitive.Row.Props): React.JSX.Element {
  return (
...
function AutocompleteValue({
  ...props
}: AutocompletePrimitive.Value.Props): React.JSX.Element {
  return (
...
function AutocompleteList({
  className,
  ...props
}: AutocompletePrimitive.List.Props): React.JSX.Element {
  return (
...
function AutocompleteStatus({
  className,
  ...props
}: AutocompletePrimitive.Status.Props): React.JSX.Element {
  return (
...
function AutocompleteCollection({
  ...props
}: AutocompletePrimitive.Collection.Props): React.JSX.Element {
  return (
...
function AutocompleteTrigger({
  ...
  children,
  ...props
}: AutocompletePrimitive.Trigger.Props): React.JSX.Element {
  return (
